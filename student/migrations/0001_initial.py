# Generated by Django 4.2.19 on 2025-04-02 10:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_alter_administrator_options_student_theme_preference'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='job',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='student.company'),
        ),
        migrations.AddField(
            model_name='job',
            name='recruiter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posted_jobs', to='accounts.recruiter'),
        ),
        migrations.AddIndex(
